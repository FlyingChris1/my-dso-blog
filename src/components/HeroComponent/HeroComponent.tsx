        ...
        <div className={styles.heroContent}>
          <div className={styles.heroMyprofile}>
            ...
            <p className={styles.pLine}>
              I’m a DevSecOps Engineer and System Administrator with a strong focus on automation, security, and reliable infrastructure. 
              I enjoy designing scalable systems, improving CI/CD pipelines, and hardening environments to meet modern security standards. 
              Continuous learning is a core part of my work.
            </p>
            <a href="#contact">
